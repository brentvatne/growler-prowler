...
const breweries = [
  {
    ...
    "description":"Created by Main Street locals who believe in beer that tastes like... Beer.\n\nMain Street Brewing resides in one of Vancouver\u2019s few surviving industrial heritage buildings.\nThe \u201cVancouver Breweries Garage\u201d dates back to 1913 and sits in the historic Brewery Creek district, an area once dominated by tanneries & breweries and which we now proudly call home.\n\nThe Main Thing Is The Beer!",
    "phone":16043367711,
    ...
    "social_untappd":"8418",
    // "logo": require('../images/breweries/mainst.png'),
    // "banner": require('../images/breweries/mainst-banner.jpg'),
  ...
  },
  {
    ...
    "description":"First & foremost, we are a manufacturer. We make beer.\nThat\u2019s it. The public space at Brassneck, i.e. the Growler Shop & Tasting Room are designed to have you, our customers feel as though you are part of our process. The brew house & cellar wrap around the tasting room & growler shop putting you in the very heart of the Brewery.\nWe have a special type of liquor license. A Brewery Lounge. Patrons do not have to be seated as in many other Food Primary locations. This combined with our communal tables makes for a pleasant social environment.\nFor now, though we are on the verge of expanding our production capabilities, we have a really tiny 10 Hec system, with an even smaller Nano system for batches of around 4 Hecs.\nEven though our system is small, we have lots of different fermenters. 10 in total. This allows us to brew lots of different beers on a constantly rotating basis.\nWe are ALWAYS experimenting with different beer styles. We are only 8-9 months old & we\u2019ve already brewed over 50 different beers. From Barrel Aged Imperial Stouts to Corn Lagers, Sour beers to English Milds, Brett Primary Fermented Wheat Ales to Traditional Saisons, the scope of beer styles is endless & we intend to cover them all!\nOur beer comes to you direct from the conditioning tanks in our cellar & sells out quickly, so it\u2019s always fresh.\nWe\u2019re always evolving so get ready for more great beers as time goes by & we expand production & have greater capacity for experimentation.\n",
    "phone":16042597686,
    ...
    "logo":"http://storage.growlerfill.ca/3/brassneck.png",
  ...
  },
  {
    ...
    "logo":"http://storage.growlerfill.ca/145/bigrock.png",
